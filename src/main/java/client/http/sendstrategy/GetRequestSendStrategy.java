...
public class GetRequestSendStrategy extends BaseStrategy {

    public GetRequestSendStrategy(Communicator communicator, HttpParser httpParser, Converter convertor) {
